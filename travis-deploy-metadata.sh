...
git clone --branch=gh-pages    https://github.com/tprasadtp/lineageos-apk-extractor gh-deploy 2>&1 > /dev/null
...
git push -fq https://valarie-ci-bot:${GH_TOKEN}@github.com/tprasadtp/lineageos-apk-extractor gh-pages 2>&1 > /dev/null
popd